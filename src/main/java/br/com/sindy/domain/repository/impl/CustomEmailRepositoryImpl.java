...
public class CustomEmailRepositoryImpl implements CustomEmailRepository {
    private static final String SELECT_ALL_EMAILS = "SELECT new br.com.sindy.dto.email.EmailResponseDto(ch.id, ch.sender, ch.recipients, ch.message, ch.subject, ch.status)" +
